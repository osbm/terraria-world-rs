    ...
    pub fn new(world_name: String, world_size: String, difficulty: String) -> Self {
        ...
        Self {
            ...
            environment: WorldEnvironment {
                moon_style: 0,
                tree_style_separators: Vec::new(),
                tree_style_properties: Vec::new(),
                moss_style_separators: Vec::new(),
                moss_style_properties: Vec::new(),
                ...
                cloud_number: 0,
                wind_speed: 0.0,
                treetop_variants: Vec::new(),
            },
            weather_events: WeatherAndEvents {
                current_time: 0.0,
                is_daytime: false,
                moon_phase: 0,
                blood_moon: false,
